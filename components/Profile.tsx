...
import { User, CreditCard, MessageSquare, Save, Settings, ImageIcon, Video } from 'lucide-react';
...
export const Profile: React.FC<ProfileProps> = ({
  ...
  return (
    <div className="flex flex-col h-full overflow-y-auto">
      <div className="max-w-4xl mx-auto w-full p-4 md:p-6 lg:p-10 pt-16 md:pt-6 space-y-6 md:space-y-8">
