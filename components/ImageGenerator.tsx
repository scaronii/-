    ...
    <div className="flex flex-col h-full overflow-y-auto">
      <div className="max-w-6xl mx-auto w-full p-6 lg:p-10 space-y-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div>
            <h1 className="text-4xl font-bold text-charcoal mb-2 flex items-center gap-3">
              <span className="w-12 h-12 bg-purple-100 text-purple-600 rounded-2xl flex items-center justify-center">
                <Wand2 size={24} />
              </span>
              Генерация Изображений
            </h1>
            <p className="text-gray-500 font-medium">Создавайте искусство с помощью Nano Banana Pro, Flux и других.</p>
          </div>
          <div className="bg-white px-4 py-2 rounded-xl shadow-sm border border-gray-100 text-sm font-medium text-gray-500">
             Баланс: <span className="text-charcoal font-bold">50,000</span> токенов
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-4 space-y-6">
            <div className="bg-surface p-6 rounded-[2rem] shadow-soft border border-gray-50 space-y-6">
              <div>
                ...
                <div className="relative">
                  <select 
                    ...
                    className="w-full bg-gray-50 text-charcoal font-medium border border-gray-200 rounded-2xl px-5 py-3.5 appearance-none focus:ring-2 focus:ring-lime focus:outline-none transition-all cursor-pointer hover:bg-gray-100"
                  >
                    {IMAGE_MODELS.map(m => (
              ...
              <div className="pt-4 border-t border-gray-100">
                 <div className="flex justify-between items-center bg-lime/10 p-4 rounded-2xl">
                    ...
                    <span className="text-charcoal font-bold">~5000 токенов</span>
                 </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            <div className="bg-surface p-2 rounded-[2.5rem] shadow-soft border border-gray-50">
              <textarea
                ...
                className="w-full bg-transparent text-charcoal placeholder-gray-400 resize-none p-6 text-lg focus:outline-none min-h-[140px] rounded-[2rem]"
              />
              <div className="flex items-center justify-between px-4 pb-4">
                <button 
                  onClick={handleRandomPrompt}
                  className="px-4 py-2 rounded-full text-xs font-bold bg-gray-100 text-gray-600 hover:bg-gray-200 transition-colors"
                >
                  Случайный промпт
                </button>
                <button
                  ...
                  className="bg-lime hover:bg-[#b0e61a] text-charcoal px-8 py-3.5 rounded-full font-bold flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-glow hover:scale-105 active:scale-95 text-base"
                >
            ...
            {/* Result Area */}
            <div className="bg-surface rounded-[3rem] border border-gray-50 shadow-soft min-h-[500px] flex items-center justify-center relative overflow-hidden group p-4">
              {isGenerating ? (
                <div className="text-center space-y-6">
                  <div className="relative">
                    <div className="w-20 h-20 rounded-full border-4 border-gray-100"></div>
                    <div className="w-20 h-20 rounded-full border-4 border-lime border-t-transparent animate-spin absolute top-0 left-0"></div>
                  </div>
                ...
                <>
                  ...
                  <div className="absolute bottom-6 right-6 flex gap-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <a 
                      ...
                      className="bg-white text-charcoal p-4 rounded-full shadow-lg hover:scale-110 transition-transform"
                    >
                      <Download size={24} />
                    </a>
                  </div>
                ...
                <div className="bg-red-50 text-red-500 text-center p-8 rounded-3xl max-w-md">
                  <p className="font-bold">{error}</p>
                </div>
              ) : (
                <div className="text-center text-gray-300">
                  <ImageIconSmall size={80} className="mx-auto mb-6 opacity-30" />
                  <p className="text-xl font-medium">Здесь появится шедевр</p>
                </div>
              )}
            </div>
          </div>
