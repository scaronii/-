...
export const FAQ_ITEMS = [
  ...
  { q: 'Есть ли бесплатный доступ?', a: 'Да! Первые 10 сообщений с простыми моделями абсолютно бесплатны, также доступна бесплатная генерация изображений через Gemini и создание музыки.' },
